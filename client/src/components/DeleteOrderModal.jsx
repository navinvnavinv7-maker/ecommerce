...
export default function DeleteOrderModal({
  ...
  return (
    <AnimatePresence>
      {orderToDelete && (
        <div id="delete_order_modal_overlay" className="fixed inset-0 bg-zinc-950/80 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <motion.div
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-zinc-400 text-xs font-sans">
                Are you sure you want to permanently delete order <strong className="text-zinc-250">"#{orderToDelete.id}"</strong> for <strong className="text-zinc-250">{orderToDelete.customer}</strong>? This action is irreversible.
              </p>
            </div>

            <div className="pt-2 flex gap-3">
              <button
                id="delete_order_cancel_btn"
